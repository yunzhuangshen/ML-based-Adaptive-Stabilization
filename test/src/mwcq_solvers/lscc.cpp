...
long long LSCC::Max_Tabu()
{
	 ...
	 while(1)
     {
        ...
        sol_times.push_back(real_solve1);
         ...
         if (iter_no_improve >= 10*nv) return lbest;
...
long long LSCC::lscc(long long nb_vtx, long long nb_edge, double cutoff, long long** AdjacentList, long long* Node_Degree, long long* Node_Weight, int seed){
    nv=nb_vtx;
    ne=nb_edge;
    Max_Vtx = nb_vtx;
